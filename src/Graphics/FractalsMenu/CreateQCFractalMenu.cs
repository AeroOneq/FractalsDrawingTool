...
namespace Graphics
{
    public class CreateQCFractalMenu : CreateFractalMenu
    {
        ...
        { 
            ...
            Button additionalSettings = new Button()
            {
                Background = new SolidColorBrush(Color.FromRgb(255, 0, 255)),
                Width = 100,
                Height = 40,
                ...
                VerticalAlignment = VerticalAlignment.Bottom,
                HorizontalAlignment = HorizontalAlignment.Left,
                Margin = new Thickness(120, 0, 0, 20),
                Style = mainWindow.Resources["goBtnStyle"] as Style
            };
            #endregion
            ...
            additionalSettings.MouseEnter += (sender, e) =>
            {
                ((Button)sender).Background = new SolidColorBrush(
                    Color.FromRgb(210, 0, 210));
            };
            additionalSettings.MouseLeave += (sender, e) =>
            {
                ((Button)sender).Background = new SolidColorBrush(
                    Color.FromRgb(255, 0, 255));
            };
            #endregion
            paramsGrid.Children.Add(additionalSettings);
            if (oldButton == null)
            {
